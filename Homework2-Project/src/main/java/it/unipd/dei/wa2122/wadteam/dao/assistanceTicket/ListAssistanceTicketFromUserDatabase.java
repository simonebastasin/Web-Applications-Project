...
public class ListAssistanceTicketFromUserDatabase {
    /**
     * The SQL statement to be executed
     */
    private static final String STATEMENT = "SELECT * FROM Assistance_Ticket WHERE id_customer = ? ORDER BY id ASC";
    private static final String STATEMENT_STATUS = "SELECT id, status, description, ts_date, id_ticket FROM ticket_status WHERE id_ticket = ? ORDER BY ts_date ASC";
     ...
     *            the connection to the database.
     */
    public ListAssistanceTicketFromUserDatabase(final Connection con, final int idCustomer) {
        this.con = con;
     ...
     */
    public List<AssistanceTicket> getAssistanceTicketFromUser() throws SQLException {
