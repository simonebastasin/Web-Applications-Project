...
public class GetOnlineInvoiceFromOrderDatabase {


    /**
     * The SQL statement to be executed
     */
    private static final String STATEMENT = "SELECT * FROM Online_Invoice WHERE id_order = ?";
     ...
     */
    public GetOnlineInvoiceFromOrderDatabase(final Connection con, final int id) {
        this.con = con;
        this.id = id;
    }
