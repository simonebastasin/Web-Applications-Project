...
%\texttt{/rest/buy/product} ? & GET \& POST & performs a check on the product order if it is eligible or not & C\\\hline
%\texttt{/rest/buy/confirmed} ? & GET \& POST & finalize an order & C\\\hline
%\texttt{/rest/buy/} & & & C\\\hline
