...
\begin{itemize}
    ...
    \item Error Response: a JSON Object: with a key: \textt{isError}  and value \textt{true}, an error code, a message and details of the error.
